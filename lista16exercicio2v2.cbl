      ...
      *>   Declaração do arquivo
           select arqEstados assign to "arqEstados.dat"
      ...
      *>                            ----+----+----+----+----+----+----+----+----+----+----+----+----+----+----+----+
           05 blank screen.
           05 line 01 col 01 value "                                                                     [ ]Sair     ".
           05 line 02 col 01 value "                             Estados Brasileiros                                 ".
           05 line 03 col 01 value "                                                                                 ".
      ...
      *>                            ----+----+----+----+----+----+----+----+----+----+----+----+----+----+----+----+
           ...
           05 line 08 col 01 value "  Terceiro Colocado:                                        Pontos:              ".
           05 line 09 col 01 value "  Quarto Colocado:                                          Pontos:              ".
           05 line 22 col 01 value "              [__________________________________________________]               ".
           ...
           05 sc-nome-jog2-rel           line 08  col 21 pic x(25)
           from ws-nome-jog(3) foreground-color 12.

           05 sc-pontos-jog2-rel         line 08  col 68 pic 9(02)
           from ws-pontos(3) foreground-color 12.

           05 sc-nome-jog1-rel           line 09  col 21 pic x(25)
           from ws-nome-jog(4) foreground-color 12.

           05 sc-pontos-jog1-rel         line 09  col 68 pic 9(02)
      ...
      *>    inicialização da tabela de estados
           ...
           if ws-fs-arqEstados <> 0 then
               ...
               move "Erro ao abrir arquivo: (arqEstados) " to ws-msn-erro-text
           ...
           perform varying ws-ind-est from 1 by 1 until ws-fs-arqEstados = 10
               ...
               and ws-fs-arqEstados <> 10 then
                   ...
                   move ws-fs-arqEstados                 to ws-msn-erro-cod
                   move "Erro ao ler arquivo: (arqEstados) "   to ws-msn-erro-text
                   perform finaliza-anormal
               end-if
           ...
           if ws-fs-arqEstados <> 0 then
               ...
               move ws-fs-arqEstados                  to ws-msn-erro-cod
               move "Erro ao fechar arquivo: (arqEstados) " to ws-msn-erro-text
               perform finaliza-anormal
           end-if
           ...
           perform until ws-sair = "X"
               ...
               perform varying  ws-ind-jog  from 1 by 1 until ws-ind-jog > 4
                   ...
                   if ws-capital-jog = ws-capital(ws-ind-est) then
                         ...
                         move "Voce acertou!"  to ws-msn
                   else
                         move "Infelizmente, voce errou!"    to ws-msn
                   end-if
